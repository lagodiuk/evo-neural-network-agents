...
public enum ThresholdFunctions implements ThresholdFunction {
	...
	// maven don't want to compile sources without this stub method
	// but this method is unnecessary - it is implemented in each instance of
	// enum
	// TODO find how to fix this issue
	@Override
	public double calculate(double value, List<Double> params) {
		// Stub
		return 0;
